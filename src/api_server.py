...
# TODO: Replace this dummy state with actual integration with src.state_manager
BOT_STATE = {
    "status": "running",
    "portfolio_value": 10500.00,
    "positions": [
        {"symbol": "SOL/USDC", "side": "long", "size": 15.5, "entry_price": 145.20, "unrealized_pnl": 25.50}
    ],
    "history": [
        {"id": 1, "symbol": "JUP/USDC", "side": "buy", "price": 1.10, "amount": 100, "timestamp": "2026-04-13T10:00:00Z"}
    ],
...
async def update_config(config_update: ConfigUpdate):
    ...
    return {"message": "Configuration updated successfully", "new_config": BOT_STATE["config"]}
